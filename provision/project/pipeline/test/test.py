...
class TestShadowUpdateFunction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            with open(PARAMETER_FILE, "r+") as json_file:
                ...
                self.device_name = deployment_parameter_sets['targetArn']
                # self.device_name = "arn:aws:iot:us-west-2:465906353389:thing/JetsonXavierCore"
        except:
    ...
    def test_echo(self):
        ...
        input_topic = '{}/shadow/update'.format(self.device_name)
        print(input_topic)
